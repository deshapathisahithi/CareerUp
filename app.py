...
model = pickle.load(open("C:/Users/dell/Desktop/resume projects/project 4/career path advisor/public/career_pkl.pkl", "rb"))
...
def internal_server_error(e):
    return render_template('error.html'), 50